      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          <div class="flex items-center space-x-4">
            ...
            <h1 class="text-xl font-semibold text-gray-900">Create New Service</h1>
          </div>
        </div>
      </div>
    </nav>
        ...
        <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
          <div class="space-y-6">
            ...
            <div>
              ...
              />
              <p class="mt-1 text-sm text-gray-500">Upload an image for this service (JPEG, PNG, JPG, GIF - Max: 2MB)</p>
